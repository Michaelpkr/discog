...
export default function Day3() {
  return (
      <div>
         ...
         <h2>The fix</h2>
         <p>Spotify has a separate endpoint that returns the full artist object. So I added a second API call: for each artist from the search, fetch their full details individually. That meant ten separate requests instead of one, but it was the only way to get the data I needed.</p>
